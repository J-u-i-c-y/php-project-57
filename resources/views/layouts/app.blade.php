...
<div id='app'>
    <header class="fixed w-full">
        <nav class="bg-white border-gray-300 py-2.5 dark:bg-gray-700 shadow-md">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                ...
                <div class="flex items-center lg:order-2">
                    @guest
                        <a href="/login" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">{{ __('auth.Log in') }}</a>
                        <a href="/register" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-2">{{ __('auth.Register') }}</a>
                    @endguest
                    @auth
